...
public:
    ...
    bool legalizePlacement(std::vector<circuit::Cell> cells, ophidian::util::MultiBox legalizationArea);
    bool legalizeSubrows(std::vector<circuit::Cell> &cellsForOneHeight, unsigned rowsPerCell, placement::RowAlignment alignment, util::MultiBox legalizationArea);
};
} // namespace legalization
} // namespace ophidian

...
public:
    ...
    bool legalizeSubrows(const std::vector<circuit::Cell> & totalCells, std::vector<circuit::Cell> &cellsForOneHeight, unsigned rowsPerCell, placement::RowAlignment alignment, util::MultiBox legalizationArea, double maxDisplacement = 0);
};
} // namespace legalization
} // namespace ophidian
